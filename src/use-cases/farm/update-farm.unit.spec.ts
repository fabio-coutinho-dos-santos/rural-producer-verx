...
import { farmStub, inputUpdateFarmStub, inputUpdateFarmStubInvalidArea, validUuidFormat } from "../@shared/tests/stub"
...
describe('Update Farm use case', () => {
  describe('validate producer', () => {
    it('should return void with valid data', async () => {
      ...
      const producerRepository: ProducerRepositoryInterface = ProducerMockRepository(returnProducerFlag)
  ...
  describe('execute function', () => {
    it('should return void with valid data', async () => {
      ...
      const farmUpdated = await updateFarm.execute(inputUpdateFarmStub(), validUuidFormat())
      ...
      expect(spyBuildCompleteFarm).toHaveBeenCalledWith(inputUpdateFarmStub(), validUuidFormat())
    ...
    it('should return an error with invalid area proportion', async () => {
      expect(async () => {
        ...
        const producerRepository: ProducerRepositoryInterface = ProducerMockRepository(returnProducerFlag)
        const updateFarm = new UpdateFarm(farmRepository, producerRepository);
        const farmUpdated = await updateFarm.execute(inputUpdateFarmStubInvalidArea(), validUuidFormat())
      }).rejects.toThrow();
    })
  })
})